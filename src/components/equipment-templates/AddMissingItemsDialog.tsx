...
import { useCreateInventoryCheckItem } from "@/hooks/useTemplateInventory";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>Nicht geprüfte Positionen</DialogTitle>
        ...
        <div className="flex-1 overflow-y-auto space-y-3">
          {missingItems.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground">
                Sie können die Inventur jetzt abschließen.
              </p>
            </div>
          ) : (
            <>
        ...
        <div className="flex justify-between gap-2 pt-4 border-t">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            >
              {missingItems.length > 0 ? "Überspringen" : "Schließen"}
            </Button>
            <Button 
              onClick={handleSkipAndComplete}
